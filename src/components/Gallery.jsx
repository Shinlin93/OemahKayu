...
export default function Gallery() {
  return (
    <section id="galeri" className="py-20 bg-[#F5EFE6] border-t border-[#2C1A0E]/8">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="text-[#B8962E] text-sm tracking-wider flex items-center gap-1 uppercase font-medium hover:gap-3 transition-all duration-300"
          >
            Minta Galeri Lengkap <IconChevron />
          </a>
        </div>
