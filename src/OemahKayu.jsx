...
export default function OemahKayuLanding() {
  ...
  return (
    <main>
      ...
      <footer className="photo-footer" style={{ backgroundImage: "linear-gradient(180deg, rgba(13,24,18,.16), rgba(13,18,12,.72) 58%, rgba(10,13,9,.94)), url('/assets/belakang-1.webp')" }}><div className="photo-footer-content"><div className="footer-cta"><SectionLabel>Come as you are</SectionLabel><h2>Ready to find<br /><em>your quiet?</em></h2><a className="button button-light" href={whatsapp}>Chat via WhatsApp <Arrow /></a></div><div className="footer-details"><a className="brand" href="#top"><span>Oemah</span> Kayu</a><p>Private wooden retreat<br />Prigen, Pasuruan · East Java, Indonesia</p><div><a href="#house">The house</a><a href="#gallery">Gallery</a><a href={whatsapp}>WhatsApp</a></div><small>© {new Date().getFullYear()} Oemah Kayu</small></div></div></footer>
