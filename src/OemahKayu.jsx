...
export default function OemahKayuLanding() {
  ...
  return (
    <main>
      ...
      <section className="visit section-pad" id="visit"><div className="visit-copy"><SectionLabel>06 — Find your way</SectionLabel><h2>Close enough<br /><em>to get away.</em></h2><p>Oemah Kayu is in Prigen, Pasuruan, East Java — a refreshing escape near the slopes of Mount Penanggungan, surrounded by cool mountain air and green landscapes.</p><a className="button button-dark" href={whatsapp}>Plan your visit <Arrow /></a></div><div className="map-card"><img src="/assets/Ke-Villa.webp" alt="The road leading to Oemah Kayu" /><div className="map-overlay"><span>OEMAH KAYU</span><strong>Prigen, Pasuruan</strong><small>East Java, Indonesia</small></div></div></section>
