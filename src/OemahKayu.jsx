...
export default function OemahKayuLanding() {
  ...
  return (
    <main>
      ...
      <footer className="photo-footer"><img className="photo-footer-image" src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/belakang-1.webp_2K_20260923123300-QEHrDI2mLq8z28VfHA49IWeNAeYPLG.jpeg" alt="Halaman belakang Oemah Kayu dengan taman dan area bersantai" /><div className="photo-footer-shade" aria-hidden="true" /><div className="photo-footer-content"><a className="brand" href="#top"><span>Oemah</span> Kayu</a><p>Private wooden retreat<br />Prigen, Pasuruan · East Java, Indonesia</p><div><a href="#house">The house</a><a href="#gallery">Gallery</a><a href={whatsapp}>WhatsApp</a></div><small>© {new Date().getFullYear()} Oemah Kayu</small></div></footer>
